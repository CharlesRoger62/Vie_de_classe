          ...
          children: <Widget>[
                        ...
                        showDialog(
                          ...
                          builder: (BuildContext context) {
                            return AlertDialog(
                              ...
                              content: Text("Vous allez changer de mode : toutes vos notes vont être réinitialisées !"),
                              actions: [
                                FlatButton(
                                    onPressed: () {
                                      Navigator.of(context).pop();
            ...
            Padding(
              padding: EdgeInsets.only(left: 10.0),
                child: Text(
                    Data().mode ? "  Le mode standard fait commencer les notes des élèves à 20 pour et place les moins bonnes notes en premier." :
        ...
        child: SizedBox(
          ...
          child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                return ClasseCard(classe: Data().classes[index], modifier: false);
              }
          ),
        ),
      ),
